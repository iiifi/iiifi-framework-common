 ...
 */
package com.iiifi.framework.server.common.basedb.mybatis.spring;
...
import com.iiifi.framework.server.common.basedb.apache.ibatis.builder.xml.XMLMapperBuilder;
...
public class SqlSessionFactoryBean implements FactoryBean<SqlSessionFactory>,
	...
	protected SqlSessionFactory buildSqlSessionFactory() throws IOException {
		...
		new com.iiifi.framework.server.common.basedb.apache.ibatis.thread.Runnable(location, configuration).run();
