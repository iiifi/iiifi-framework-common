package com.iiifi.framework.server.common.common.persistence;

import com.fasterxml.jackson.annotation.JsonIgnore;
import com.iiifi.framework.server.common.common.config.IiifiConstant;
import com.iiifi.framework.server.common.common.utils.CookieUtils;
...
public class Page<T> {
	...
	private int pageSize = Integer.valueOf(IiifiConstant.getConfig("page.pageSize")); // 页面大小，设置为“-1”表示不进行分页（分页无效）
...
//			firstResult = Integer.valueOf(String.valueOf(getCount()));
//		}
		return firstResult;
	}
	/**
