...
public class JedisUtils {
	...
	public static final String KEY_PREFIX = IiifiConstant.getConfig("redis.keyPrefix");
	 ...
	 * @param o
	 */
	public static void hset(String key,String field,Object object){ 
		Jedis jedis = null;
		try {
			jedis = getResource();
			jedis.hset(key,field,JsonMapper.toJsonString(object));
			logger.warn("hset {} set {} {}",key,field,object);
		} catch(Exception e){
			logger.warn("hset {} set {} {}",key,field,e);
		} finally {
			returnResource(jedis);    
		}
	}    
	...
	public static <T> T hget(String key,String field,Class<T> clazz){     
		...
		return (T) JsonMapper.fromJsonString(text, clazz);
	}    
	/**     
	 * 
	 * *从Hash中删除对象    
